    ...
    return (
            <div className='flex items-center justify-center h-60'>
                        <Link href={link.calidad.urlBackOffice.interno}>
                            <button className="bg-transparent hover:bg-black text-black dark:text-white dark:hover:bg-white dark:hover:text-black font-semibold hover:text-white py-2 px-4 border border-black hover:border-transparent rounded m-5 p-9">{link.calidad.urlBackOffice.name} Interno</button>
                        </Link>
                        <Link href={link.calidad.urlBackOffice.externo}>
                            <button className="bg-transparent hover:bg-black text-black dark:text-white dark:hover:bg-white dark:hover:text-black font-semibold hover:text-white py-2 px-4 border border-black hover:border-transparent rounded m-5 p-9">{link.calidad.urlBackOffice.name} Externo</button>
                        </Link>
